...
function addComponent(wall = 'front', componentType = 'door', specificType = '') {
    ...
    if (componentType === 'door') {
        ...
        <option value="4ft_Double_Door">4ft Double Door</option>
        <option value="4ft_Transom_Double Door">4ft Transom Double Door</option>

        <option value="5ft_Double_Door">5ft Double Door</option>
        <option value="5ft_Transom_Double Door">5ft Transom Double Door</option>
